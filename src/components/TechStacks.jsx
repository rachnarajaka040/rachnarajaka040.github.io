...
>
 <SkillTitleItem mtitle={"Tech Stacks"} ltitle={'Frontend'} rtitle={"Backend"} />
  ...
  <SkillItem  skill='Firebase' >   <SiFirebase size="18px" color="white" />                                 2</SkillItem>
  <SkillItem  skill='Hreoku' >    <SiHeroku size="18px" color="white" />                                3</SkillItem>
  <SkillItem  dis='none'>                           4</SkillItem>
  <SkillItem  dis='none' >                          5</SkillItem>
  <SkillItem  skill='DSA' >   <DsaIcon/>                                 6</SkillItem>
  <SkillItem  skill='Node' > <FaNodeJs size="18px" color="white"/>                                    7</SkillItem>
  <SkillItem  skill='Express' >  <SiExpress size="18px" color="white" />                                  8</SkillItem>
  <SkillItem   dis='none'>                          9</SkillItem>
  <SkillItem  skill='HTML' > <AiFillHtml5 size="18px" color="white"/>                                10</SkillItem>
  <SkillItem  skill='CSS' >   <SiCss3 size="18px" color="white"/>                               11</SkillItem>
  <SkillItem  dis='none'>                          12</SkillItem>
  <SkillItem  skill='MongoDB' > <SiMongodb size="18px" color="white"/>                                  13</SkillItem>
  <SkillItem  skill='mongoose' >      <MongooseIcon/>                           14</SkillItem>
  <SkillItem  skill='' >                                   15</SkillItem>
  <SkillItem  skill='JavaScript' >    <SiJavascript size="18px" color="white" />                               16</SkillItem>
  <SkillItem  skill='React' >     <SiReact size="18px" color="white" />                                17</SkillItem>
  <SkillItem  skill='Redux' >         <SiRedux size="18px" color="white" />                          18</SkillItem>
  <SkillItem  dis='none' >                         19</SkillItem>
  <SkillItem  skill='' >                                   20</SkillItem>
  <SkillItem  skill='' >                                   21</SkillItem>
  <SkillItem  dis='none'>                          22</SkillItem>
  <SkillItem  skill='Chakra-UI' >   <SiChakraui size="18px" color="white" />                                23</SkillItem>
  <SkillItem  skill='Flutter' >    <SiFlutter size="18px" color="white" />                               24</SkillItem>
