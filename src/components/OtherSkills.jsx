  ...
  return (
    ...
    >
      ...
      <SkillItem skill="Github">
        {" "}
        <SiGithub size="18px" color="white" /> 2
      </SkillItem>
      <SkillItem skill="Netlify">
        {" "}
        <SiNetlify size="18px" color="white" /> 3
      </SkillItem>
      <SkillItem dis="none"> 4</SkillItem>
      <SkillItem dis="none"> 5</SkillItem>
      <SkillItem skill="CLI Bash">
        {" "}
        <FcCommandLine size="18px" color="white" /> 6
      </SkillItem>
      <SkillItem skill="Cypress">
        {" "}
        <SiCypress size="18px" color="white" /> 7
      </SkillItem>
      ...
      <SkillItem skill="Team Work">
        {" "}
        <TeamworkIcon /> 10
      </SkillItem>
      <SkillItem skill="Ownership">
        {" "}
        <AccountabilityIcon /> 11
      </SkillItem>
      <SkillItem dis="none"> 12</SkillItem>
      <SkillItem skill="Adobe XD">
        {" "}
        <SiAdobexd size="18px" color="white" /> 13
      </SkillItem>
      <SkillItem skill="Inkscape">
        {" "}
        <SiInkscape size="18px" color="white" /> 14
      </SkillItem>
      <SkillItem skill="Fusion360">
        {" "}
        <F360Icon /> 15
      </SkillItem>
      <SkillItem skill="Adaptable">
        {" "}
        <AdaptabilityIcon /> 16
      </SkillItem>
      <SkillItem skill="Self Learn">
        {" "}
        <SelfstudyIcon /> 17
      </SkillItem>
      <SkillItem skill="Creative">
        {" "}
        <ProblemSolvingIcon /> 18
      </SkillItem>
      <SkillItem dis="none"> 19</SkillItem>
      <SkillItem skill="Eagle">
        {" "}
        <EagleIcon /> 20
      </SkillItem>
      <SkillItem skill="Arduino">
        {" "}
        <SiArduino size="18px" color="white" /> 21
      </SkillItem>
      <SkillItem dis="none"> 22</SkillItem>
      <SkillItem skill="Growth">
        {" "}
        <FaTree size="18px" color="white" /> 23
      </SkillItem>
